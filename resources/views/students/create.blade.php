        ...
        <section class="container">
            ...
            <div class="form">
                <form class="form-horizontal" role="form" action="{{ route('student.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="dept" class="col-md-2 control-label">Dept</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="dept" id="dept" value="{{ old('dept') }}" placeholder="CSE">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="registration_no" class="col-md-2 control-label">Registration*</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" name="registration_no" id="registration_no" value="{{ old('registration_no') }}" placeholder="201.....">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="date_of_birth" class="col-md-2 control-label">Date of Birth*</label>
                        <div class="col-md-4">
                            <input type="date" class="form-control" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth') }}" placeholder="01/31/2018">
                        </div>
                    </div>
