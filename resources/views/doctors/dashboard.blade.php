              ...
              <div>
                <section style="margin: 40px" class="">
                  ...
                  <div class="col-lg-4 col-sm-7">
                    <a href="http://ims.iitds.win/admin/schedules/pending">
                        <div class="widget-panel widget-style-2 white-bg">
                            <i class="ion-eye text-purple"></i>
                            <div><p style="font-size: 20px">You have {{ count($appointments) }} appointments today</p></div>
                        </div>
                    </a>
                </div>
