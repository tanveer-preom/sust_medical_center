  ...
  <aside class="left-panel" tabindex="5000" style="overflow: hidden; outline: none;">
    ...
    <nav class="navigation">
      <ul class="list-unstyled">
        ...
        <li><a href="/home"><i class="ion-location"></i> <span class="nav-label">Doctors</span></a>
        </li>

        <li><a href="/appointment"><i class="ion-grid"></i> <span class="nav-label">My Appointments</span></a>
        </li>

        <li class="active"><a href="/prescriptions"><i class="ion-grid"></i> <span class="nav-label">Prescriptions</span></a>
        </li>
             ...
             <section class="content">
              ...
              <div>
                <section class="">
                  <h2 style="margin: 40px">My Prescriptions</h2>
                  <style>
